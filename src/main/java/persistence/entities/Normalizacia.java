...
public class Normalizacia {
    ...
    public Normalizacia(Long id, Long phoneId, Long userId, Long documentId, Float fingerOrientation, Float vectorTime, Float vectorDistance, Float vectorPressure, Float vectorCovered) {
        Id = id;
    ...
    public boolean equals(Object o) {
        ...
        Normalizacia that = (Normalizacia) o;
